    ...
    return (
        <>
            ...
            <div className="sl-m-menu">
                ...
                ></div>
                <div className={menuOpen ? "sl-m-menu-container active" : "sl-m-menu-container"}>
                    ...
                    <ul className="sl-m-menu-list">
                        ...
                        >
                            <div className={subMenuOpen ? "sl-m-menu-sub-open active" : "sl-m-menu-sub-open"}>
                                <span>고객지원</span>
                                <img src={subMenuOpen ? "img/icon/ic-minus.png" : "img/icon/ic-plus.png"} alt="more" />
                            </div>
                        </li>
