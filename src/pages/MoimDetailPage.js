      ...
      <div className="page-wrapper detail-page-wrapper">
        <div className="detail-left">
          <div className="detail-main-section">
            ...
            <div className="detail-main-info">
              ...
              <div className="detail-main-subtitle">
                우리는 일단 씁니다. 공책 1권을 채우도록
              </div>
          ...
          <div className="detail-info-section">
            ...
            <div className="detail-info">
              ...
              <div className="detail-info-img">이미지</div>
              <div className="detail-info-desc">
                글쓰기를 좋아하는데 매일같이 쓰다 말았나요? 또는, 누구에게도
                보여주지 못한 채 덮어두었나요? 그렇다면 소셜라운지 글쓰기 모임
                '공책한권'에 참여해보세요. 우리는 일단 씁니다. 공책 1권을
                채우도록. 같이 합니다. 글쓰기 습관을 위해 1주일에 1번씩 90분씩.
                글쓰기를 좋아하는데 매일같이 쓰다 말았나요? 또는 누구에게도
                보여주지도 못한 채 덮어두었나요? 그렇다면 소셜라운지 아 길다.
              </div>
            </div>
            <div className="detail-info">
              <div className="detail-info-line"></div>
        ...
        <div className="detail-right">
          <div className="detail-apply-section">
            ...
            <div className=""></div>
            <div className="detail-apply-button">신청하기</div>
          </div>
